...
void Program::setUniform(const char* name, const Eigen::Transform<float, 3, Eigen::Affine>& mat4) {
    glUniformMatrix4fv(getUniformLocation(name), 1, GL_FALSE, mat4.data());
}
...
void Program::setUniform(const char* name, const Eigen::Vector4f& vec4) {
